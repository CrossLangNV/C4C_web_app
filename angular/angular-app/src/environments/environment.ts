...
export const environment = {
  ...
  ANGULAR_DJANGO_API_GLOSSARY_URL: window["env"]["ANGULAR_DJANGO_API_GLOSSARY_URL"],
  ANGULAR_DJANGO_API_RO_URL: window["env"]["ANGULAR_DJANGO_API_RO_URL"],
  ANGULAR_DJANGO_API_CPSV_URL: window["env"]["ANGULAR_DJANGO_API_CPSV_URL"],
  ANGULAR_DJANGO_API_GLOSSARY_ANNOTATIONS_URL: window["env"]["ANGULAR_DJANGO_API_GLOSSARY_ANNOTATIONS_URL"],
  ANGULAR_DJANGO_API_RO_ANNOTATIONS_URL: window["env"]["ANGULAR_DJANGO_API_RO_ANNOTATIONS_URL"],
