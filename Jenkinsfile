        ...
        stage('Build Docker images') {
            steps {
                dir('django'){
                    ...
                    sh 'printenv'
                    sh "docker run -i --rm --env-file  ../secrets/django-docker.env.sample -v $WORKSPACE:/django ctlg-manager/django:${BRANCH_NAME}-${BUILD_ID} python manage.py collectstatic --noinput -c"
