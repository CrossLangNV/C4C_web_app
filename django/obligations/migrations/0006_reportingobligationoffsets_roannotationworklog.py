    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ro', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='obligations.ReportingObligation')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ro_offsets', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='obligations.ReportingObligationOffsets')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='obligation_user_worklog', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
