...
#     TagSerializer, ROAnnotationWorklogSerializer
from obligations.serializers import ReportingObligationSerializer, AcceptanceStateSerializer, CommentSerializer,\
    TagSerializer
...
#     # queryset = ROAnnotationWorklogSerializer.objects.all()

#     def list(self, request, *args, **kwargs):
#         annotation_worklogs = ROAnnotationWorklog.objects.filter(ro_offsets__ro__id=self.kwargs[KWARGS_RO_ID_KEY])
...
#     def delete(self, request, subject_id, document_id, annotation_id, format=None):
